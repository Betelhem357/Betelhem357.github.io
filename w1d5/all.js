...
function myFunctionTest(expected, found) {
  ...
  console.log("Expected output of filterLongWords([hello,hel,l,helloo]) is [hello,hel,helloo] "+ myFunctionTest(["hello","hel","helloo"],filterLongWords(["hello","hel","l","helloo"],2)));
